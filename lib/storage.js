...
async function getBlogCommentFieldMapping(cacheKey) {
  ...
  return { mappings: entry.mappings || [], submitButton: entry.submitButton, consentCheckboxes: entry.consentCheckboxes || null, cachedAt: entry.cachedAt };
}
...
async function saveBlogCommentFieldMapping(cacheKey, mapping) {
  ...
  mappings[cacheKey] = {
    ...
    consentCheckboxes: mapping.consentCheckboxes || null,
    cachedAt: new Date().toISOString()
  };
